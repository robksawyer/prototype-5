...
describe('components', () => {
  describe('Instances', () => {
    it('should mount with props', function () {
      const wrap = mount(<Instances>Hello World</Instances>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<Instances>Hello World</Instances>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('instances')
