/**
 * @file CircleWaveButton.test.jsx
 * @url https://devhints.io/enzyme
 * @url https://github.com/airbnb/enzyme/blob/master/docs/guides/jest.md
 */
import * as React from 'react'
import { shallow, mount, render } from 'enzyme'
import CircleWaveButton from './CircleWaveButton.jsx'

describe('components', () => {
  describe('CircleWaveButton', () => {
    it('should mount with props', function () {
      const wrap = mount(<CircleWaveButton>Hello World</CircleWaveButton>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<CircleWaveButton>Hello World</CircleWaveButton>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('circle_wave_button')
